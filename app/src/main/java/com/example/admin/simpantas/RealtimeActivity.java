...
public class RealtimeActivity extends AppCompatActivity {
    ...
    private static String url = "https://sipongi.menlhk.go.id/api/opsroom/indoHotspot";
...
//        recentDate = "14-Jun-1994";
    ...
    private class GetHotspot extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            //MAKING REQUEST
            String jsonStr = jp.getJsonData("https://sipongi.menlhk.go.id/api/opsroom/indoHotspot");
