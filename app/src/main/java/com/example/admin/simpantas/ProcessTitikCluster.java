...
public class ProcessTitikCluster extends AppCompatActivity implements Serializable{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clustering_process);
        ...
        btnInputData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                temp = 1;
                Intent i = new Intent(ProcessTitikCluster.this, InputTitikCluster.class);
